...
const switchStates = (cellIndex1, cellIndex2) => {
   ...
   const val1 = cell1.innerHTML,
      val2 = cell2.innerHTML;
...
const isAdjacentCell = (indexOfCell) => {
   ...
   if (indexOfCell < 1 || indexOfCell > countCells) return false;
...
gameField.addEventListener("touchend", function (event) {
   ...
   if (elementAfter.innerHTML == "") gameProcess(event);
});
