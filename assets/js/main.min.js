...
var createCells = function createCells() {
  ...
  var t = !0,
      ...
      n = !0,
      s = !0;
  return e % countRows == 1 && (n = !1), e % countRows == 0 && (s = !1), e / countRows <= 1 && (t = !1), e / countRows > countRows - 1 && (l = !1), !(!n || emptyCellIndex !== e - 1) || !(!s || emptyCellIndex !== e + 1) || !(!t || emptyCellIndex !== e - countRows) || !(!l || emptyCellIndex !== e + countRows);
},
...
gameField.addEventListener("click", function (e) {
  ...
  if (t.classList.contains("game-field__cell") && "" != l) {
    ...
    isAdjacentCell(_e3) && (moves++, countMoves.innerHTML = "" + moves, switchStates(_e3, emptyCellIndex), emptyCellIndex = _e3);
  }
}), gameFieldSizeButtons.forEach(function (e) {
  e.addEventListener("click", function (e) {
    var t = e.target.dataset.size;
    var l;
    gameFieldSizeWrapper.classList.add("hidden"), document.querySelector(".game-wrapper").classList.remove("hidden"), l = t, gameField.dataset.countcells = l, countCells = gameField.dataset.countcells, countRows = +Math.sqrt(countCells), emptyCellIndex = +countCells, createCells(), resetCountMoves(), gameShuffle();
  });
}), gameRestart.addEventListener("click", function () {
  resetCountMoves(), gameShuffle();
}), gameMenu.addEventListener("click", function () {
  document.querySelector(".game-wrapper").classList.add("hidden"), gameField.innerHTML = "", gameFieldSizeWrapper.classList.remove("hidden");
});