...
gameField.addEventListener("click", gameProcess), gameField.addEventListener("touchend", function (e) {
  var t = e.changedTouches[0];
  "" == document.elementFromPoint(t.clientX, t.clientY).innerHTML && gameProcess(e);
